...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return ConditionalBuilder(
      ...
      builder: (context) => screen(Screens.withAppBar),
      fallback: (context) => screen(Screens.withoutAppBar),
    );
  }
  ...
  Widget screen(Screens screens) {
    switch (screens) {
      case Screens.withAppBar:
        return Scaffold(
